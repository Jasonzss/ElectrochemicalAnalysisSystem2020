...
public class ExpDataTest {
    ...
    public void test03(){
        ...
        expData.setExpPotentialPointData(b);
        expData.setExpOriginalCurrentPointData(b);

        expData.setExpOriginalCurrent(0.0000002333333);

        System.out.println(expData.getExpPotentialPointData());
        System.out.println(expData.getExpOriginalCurrent());
    }

    @Test
    public void test04(){
        ExpData expData = new ExpData();
        System.out.println(expData.simplifyScientificNotationDouble(0.000002222225));
    }
}
