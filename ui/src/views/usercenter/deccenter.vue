  ...
  <div class="app-container">
    <div class="top">
      ...
      <el-dropdown :hide-on-click="false" @command="handleCommand">
        <span class="el-dropdown-link list">
          <span class="listtext">算法名称</span><i class="el-icon-arrow-down el-icon--right" />
        </span>
        <el-dropdown-menu slot="dropdown" class="dropmenu">
          <!--          <el-dropdown-item ref="name" command="name">-->
          <!--            <i v-show="!serachinput.name" class="el-icon-close el-icon&#45;&#45;right" />-->
          <!--            <i v-show="serachinput.name" class="el-icon-check el-icon&#45;&#45;right" />-->
      ...
      <div class="listofinput">
        <!--        <el-input placeholder="请输入录入时间">'' </el-input>-->
        <el-input v-model="searchValue.name" placeholder="请输入算法名称">'' </el-input>
        <el-input v-show="serachinput.type" v-model="searchValue.type" placeholder="请输入算法类型">'' </el-input>
        <el-input v-show="serachinput.lang" v-model="searchValue.lang" placeholder="请输入算法语言">'' </el-input>
    ...
    <div class="tablediv">
      <el-table stripe border :cell-style="{ textAlign: 'center' }" :header-cell-style="{ textAlign: 'center' }"
        ...
        <el-table-column label="算法语言" width="115" prop="algorithmLanguage.label" />
        <el-table-column label="算法审核状态" width="100" prop="algorithmStatus.label" />
        <el-table-column label="算法录入时间" width="165" prop="algorithmCreateTime" sortable />
...
import Drawer from './components/decDrawers.vue'
import AlgorithmInfoDialog from '@/views/usercenter/components/AlgorithmInfoDialog'
import { insertAlgorithm, listAlgorithm } from '@/api/algorithm'
export default {
  components: {
    Pagination,
    Drawer,
