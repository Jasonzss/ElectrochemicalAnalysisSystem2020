  ...
  <div class="app-container">
    <div class="top">
      ...
      <div class="listofinput">
        ...
        <el-input v-show="serachinput.type" v-model="searchValue.type" class="search" placeholder="请输入算法类型">'' </el-input>
        <el-input v-show="serachinput.lang" v-model="searchValue.lang" class="search" placeholder="请输入算法语言">'' </el-input>
